    ...
    <div className="App">
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          />
          <Route
            path="/Products/employer-of-record"
            element={<Globalteams />}
          />
          <Route
            path="/Products/employee-learning-management-system"
            element={<LMS />}
          />
          ...
          <Route
            path="/Services/payroll-implementation"
            element={<Payroll />}
          />
          ...
          <Route
            path="/Solutions/recruitment-software"
            element={<Recruitment />}
          />
          <Route
            path="/Solutions/onboarding-software"
            element={<Onboarding />}
          />
          <Route
            path="/Solutions/employee-management-software"
            element={<Governance />}
          />
          <Route
            path="/Solutions/single-touch-payroll-software"
            element={<PRP />}
          />
          <Route
            path="/Solutions/employee-engagement-software"
            element={<Engagement />}
          />
          <Route
            path="/Solutions/performance-management-software"
            element={<EP />}
          />
          <Route path="/Solutions/employer-of-record" element={<Remote />} />
          <Route
            path="/Solutions/offboarding-software"
            element={<Turnover />}
          />
          {/* Industry Section */}
          ...
          />
          <Route
            path="/partner-network/bookkeepers"
            element={<Bookkeepers />}
          />
          <Route
            path="/partner-network/outsourced-payroll-providers"
            element={<OPP />}
          />
