    ...
    <div>
      ...
      <div className="hero">
        <div className="righthero">
          ...
          <div><button className='button'>Request a demo</button></div>
        </div>
        <div className="lefthero">
          <iframe src="https://player.vimeo.com/video/803304932?h=8e12175b7a&dnt=1&app_id=122963&controls=0&hd=1&autohide=1&autoplay=1&loop=1&autopause=0&muted=1" style={{width:'400px', height:'500px', allow:'autoplay'}} frameborder="0"></iframe>
        </div>
      </div>
      ...
      <div className='s6-hero'>
        ...
        <div className='s6-right'>
          <div><h2>Culture and performance. <br />It’s up and up.</h2></div>
          <div>
          <p>
          Develop feedback loops, set KPIs and design custom <br /> performance reviews. Quickly build a positive performance <br /> culture for your business — where everyone is aiming for <br /> the same goals.
          </p>
          </div>
          <div>
      ...
      <div className='s7-hero'>
        <div className='s7-left'>
          <div>
            <h2>It's Payroll Software. <br />Just faster.</h2>
          </div>
          <div>
            <p>
      ...
      <div className='s8-hero'>
        ...
        <div className='s8-right'>
          <div><h2>Recruitment and onboarding. <br />Breeze through it.</h2></div>
          <div>
            <p>
      ...
      <div className='s9-hero'>
        <div>
          <div><h2>Engage your people. <br />Even on Mondays.</h2></div>
          <div>
            <p>
      ...
      <div className='s10'>
        <div className='s10-main'>
            <div><h1>We’ve got the numbers to prove it.</h1></div>
            <div className='s10-content'>
              <div className='s10-stats'>
                <div><h1>291%</h1></div>
                <div><p>return on investment for <br /> companies using <br /> Employment Hero</p></div>
              </div>
              <div className='s10-stats'>
                <div><h1>81%</h1></div>
                <div><p>Improved payroll efficiency</p></div>
              </div>
              <div className='s10-stats'>
                <div><h1>85%</h1></div>
                <div><p>Better onboarding experience</p></div>
              </div>
              <div className='s10-stats'>
                <div><h1>89%</h1></div>
                <div><p>Decreased paperwork</p></div>
              </div>
            </div>
        </div>
          ...
          <div className="card-content">
            ...
            <a className="tile-resource-type">
              <span className="span-1">
                <img style={{width:'20px', height:'20px', marginRight:'5px'}} src="https://employmenthero.com/wp-content/uploads/2021/06/Blog-20x20.png" alt="" />
              </span>
            ...
            <h3 className='card-text'>94% of Australians want to keep working remotely. <br /> Discover more insights.</h3>
          </div>
            <a href="#" className='crd-button'>Read more</a>
        </div>
        <div className='rightcrd'>
          <div className='ind1'>   
            <div className='card-body'>
              ...
              <h2 className='card-title'>30 Was to <br /> improve <br /> workplace <br /> culture[Free <br /> bundle]</h2>
              <h3 className='card-text'>A practical guide to <br /> improving your workplace <br /> culture</h3>
              <a href="#" className='crd-button'>Read more</a>
            </div>
          ...
          <div className='ind2' >
            <div className='card-body'>
              ...
              <h2 className='card-title'>Employee Reward and Recognition Guide</h2>
                <h3>Have your read this blog? <br />It's all about rewarding your <br /> employees, but not in the <br /> traditional way.</h3>
              <a href="#" className='crd-button'>Read more</a>
            </div>
      ...
      <div className="between">
        <h1 className="between-h1">
          Innovation, reliability, customer service. A tick, gold <br /> medal, five stars.
        </h1>
      </div>
      ...
      <div className="s14-hero">
        <div className='s14-left'>
            ...
            <button style={{backgroundColor:'black', color:'white'}} className='button'>Request a demo</button>
        </div>
        <div>
            <img src="https://employmenthero.com/wp-content/uploads/2023/03/QuinnYoga-HomePage-Final-Pitch-468x468.png" alt="" />
        </div>
      </div>
